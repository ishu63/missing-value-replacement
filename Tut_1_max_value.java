...
public class Tut_1_max_value {
    ...
    public static void main(String[] args) {
        ...
        try {
                ...
                File file = new File("D://4th year/DWDM/LAB(tutorial)/tut1/max_value.txt");
                ...
                while (i<record_count) {
                        ...
                        for ( String ss : arr[i]){
                            if(ss.equals(""))
                            { 
                               if(count==0 || count==2 || count==4 || count==10 || count==11 || count==12)//rows that contains numeric entry
                                {
                                    if(flag[count]==0)
                                    {
                                        int max=0;
